...
import com.fearnot.snapp.Fragments.ProgressFragment;
import com.fearnot.snapp.Interfaces.ReplaceFragmentInterface;
import com.fearnot.snapp.R;

public class ProgressActivity extends AppCompatActivity implements ReplaceFragmentInterface {
    ...
    public void replaceFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.activity_progress_container, fragment);
