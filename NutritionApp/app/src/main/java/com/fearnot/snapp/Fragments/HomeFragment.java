...
import com.fearnot.snapp.Activities.FoodActivity;
...
import com.fearnot.snapp.Views.PyramidView;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        servingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                replaceFragmentInterface.replaceFragment(servingFragment);
            }
        });
    ...
    private void setPyramid() {
        ...
        float grainsPortion = (float) dayModel.getServingsGrains();
        float veggiePortion = (float) dayModel.getServingsVeggie();
        float fruitPortion =  (float) dayModel.getServingsFruit();
        float dairyPortion = (float) dayModel.getServingsDairy();
        float meatPortion = (float) dayModel.getServingsMeat();
